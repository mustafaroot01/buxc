        ...
        <template #header>
            <div class="flex items-center">
                ...
                <h2 class="text-2xl font-bold text-gray-800 flex items-center pr-4 border-r-2 border-gray-200">
                    <BookOpenIcon class="w-6 h-6 ml-2 text-teal-600" /> إضافة مادة دراسية جديدة
                </h2>
            </div>
        </template>
                    ...
                    <div class="p-8">
                        <form @submit.prevent="submit" class="space-y-6">
                            <div>
                                ...
                                <input type="text" v-model="form.name" class="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 block w-full p-3" placeholder="مثال: الرياضيات، الفيزياء، الكيمياء..." required>
                            ...
                            <div class="flex items-center justify-end pt-4 border-t border-gray-100">
                                ...
                                <button type="submit" :disabled="form.processing" class="inline-flex items-center px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-teal-600 to-emerald-500 rounded-lg shadow-lg hover:from-teal-700 hover:to-emerald-600 transition-all disabled:opacity-50">
                                    <SaveIcon class="w-5 h-5 ml-2" /> حفظ البيانات
                                </button>
                            </div>
                        </form>
                    </div>
