...
<template>
    <Head title="إضافة مجموعة دراسية" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center">
                ...
                <h2 class="text-2xl font-bold text-gray-800 flex items-center pr-4 border-r-2 border-gray-200">
                    <UsersIcon class="w-6 h-6 ml-2 text-blue-600" /> إضافة مجموعة دراسية جديدة
                </h2>
            </div>
        </template>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    ...
                                    >
                                        ...
                                        <input type="radio" value="morning" v-model="form.study_type" class="sr-only">
                                    </div>
                                    <!-- مسائي - Evening -->
                                    <div
                                    ...
                                    >
                                        ...
                                        <input type="radio" value="evening" v-model="form.study_type" class="sr-only">
                                    </div>
                                </div>
